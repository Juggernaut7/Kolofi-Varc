    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground font-medium text-sm">
          No passwords or signups. Your Web3 wallet is your identity on Arc.
        </p>
      </div>
      ...
      <Card className="border-none shadow-2xl shadow-primary/5 bg-card overflow-hidden rounded-[2rem]">
        <CardContent className="p-8 space-y-6 text-center">
          ...
          {isConnected && address ? (
            <div className="space-y-4">
              <div className="p-4 rounded-2xl bg-muted/40 border border-border/60">
                <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Connected Account</p>
            ...
            <div className="space-y-4">
              <p className="text-xs text-muted-foreground">
                Connect MetaMask, Rabby, OKX, or any EVM wallet on Arc Mainnet.
              </p>
          ...
          <div className="pt-2 border-t border-border/40 flex items-center justify-center gap-2 text-xs text-muted-foreground">
            ...
            <span>Non-custodial smart contracts on Arc</span>
          </div>
        </CardContent>
      </Card>
    </div>
